-- I only changed the line 23 (25 if counting this comment and the following empty line)
...
function CustomWorldGenerationService:set_blueprint(blueprint)
   ...
   local seconds = Timer.measure(
      function()
         ...
         landscaper:mark_water_bodies_check(full_elevation_map, full_feature_map)--modded
